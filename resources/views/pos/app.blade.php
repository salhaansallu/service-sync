            ...
            <div class="custom-scroller">
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        <li class="{{ (in_array(Auth::user()->type, ['tv-repairs', 'other-repairs']) && Auth::user()->type == "other-repairs"? 'd-none' : '') }}">
                        ...
                        <li class="{{ (in_array(Auth::user()->type, ['tv-repairs', 'other-repairs']) && Auth::user()->type == "tv-repairs"? 'd-none' : '') }}">
                        ...
                        <li class="{{ Request::is('dashboard/categor*') ? 'active' : '' }}">
                            <a href="#categories" class="collapsed {{ company()->plan == 1 ? 'no-collapsable' : '' }}"
                                data-toggle="collapse" aria-expanded="false">
                                <svg class="svg-icon" id="p-dash2" width="20" height="20"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            <ul id="categories"
                                ...
                                <li class="{{ Request::is('dashboard/category') ? 'active' : '' }}">
                                    <a href="/dashboard/categories">
                                        <i class="fa-solid fa-minus"></i><span>List Categories</span>
                                    </a>
                                </li>
                        ...
                        <li class="{{ Request::is('dashboard/repairs*') ? 'active' : '' }}">
                            ...
                            <ul id="category"
                                ...
                                data-parent="#iq-sidebar-toggle">
                                <li class="{{ Request::is('dashboard/repairs') ? 'active' : '' }} {{ (in_array(Auth::user()->type, ['tv-repairs', 'other-repairs']) && Auth::user()->type == 'other-repairs'? 'd-none' : '') }}">
                                    <a href="/dashboard/repairs">
                                        <i class="fa-solid fa-minus"></i><span>List TV Repairs</span>
                                    </a>
                                </li>
                                <li class="{{ Request::is('dashboard/repairs/other-repairs') ? 'active' : '' }} {{ (in_array(Auth::user()->type, ['tv-repairs', 'other-repairs']) && Auth::user()->type == "tv-repairs"? 'd-none' : '') }}">
                        ...
                        <li class="{{ isAdmin()? '' : 'd-none' }} {{ Request::is('dashboard/accounts*') ? 'active' : '' }}">
                            <a href="#accounts" class="collapsed {{ company()->plan == 1 ? 'no-collapsable' : '' }}"
                                ...
                                <span class="ml-4">Account Summeries</span>
                                @if (company()->plan == 1)
                                    <span class="badge"><i class="fa-solid fa-crown text-warning"></i></span>
                                @else
                                    <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20"
                        ...
                        <li class="{{ Request::is('dashboard/expense*') ? 'active' : '' }}">
                            ...
                            <ul id="expenses"
                                ...
                                <li class="{{ Request::is('dashboard/expense/create') ? 'active' : '' }}">
                                    <a href="/dashboard/expense/create">
