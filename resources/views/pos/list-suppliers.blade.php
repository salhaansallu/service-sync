                ...
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4">
                        <div>
                            ...
                            <p class="mb-0">The customer list effectively dictates supplier presentation and provides
                                space<br> to list your suppliers and offering in the most appealing way.</p>
                        </div>
                        <a href="/dashboard/suppliers/create" class="btn btn-primary add-list"><i class="fa-solid fa-plus mr-3"></i>Add Supplier</a>
                    </div>
                </div>
                <div class="col-lg-12">
                                    ...
                                    <td class="text-start">
                                        <div class="d-flex align-items-center list-action justify-content-start">
                                            <a class="badge bg-primary mr-2" data-toggle="tooltip" data-placement="top" title="Edit product"
                                                data-original-title="Edit" href="/dashboard/supplier/edit/{{ $item->id }}"><i class="ri-pencil-line mr-0"></i></a>
